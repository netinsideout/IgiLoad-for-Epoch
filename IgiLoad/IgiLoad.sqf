...
if (isnil "IL_Variables") then
{
	...
	// Supported vehicles
	IL_Supported_Vehicles_OFFROAD = ["C_Offroad_01_F", "B_G_Offroad_01_F", "B_mas_mar_Offroad_01_F", "C_Offroad_01_EPOCH"];
...
//	END IL_Move_Attach
	...
	IL_Create_And_Attach =
	{
		...
		_m call EPOCH_server_setVToken;
